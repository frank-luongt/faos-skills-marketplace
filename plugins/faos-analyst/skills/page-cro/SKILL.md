...
---
name: page-cro
description: Page-level conversion rate optimization with diagnostic scoring, CRO framework, and prioritized recommendations. Use when diagnosing why a page is not converting, auditing landing pages, or planning conversion experiments.
...
<!-- Source: .faos/custom/skills/business/page-cro/SKILL.md -->
