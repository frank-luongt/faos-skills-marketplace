...
---
name: bitsandbytes
description: Bitsandbytes GPU quantization library for 4-bit and 8-bit inference. Use when running large models on consumer GPUs with QLoRA training support.
tags: [bitsandbytes, optimization, quantization]
---
...
<!-- Source: .faos/custom/skills/ai-research/bitsandbytes/SKILL.md -->
