...
---
name: miles
description: MILES post-training framework for LLM alignment. Use when applying iterative self-improvement or preference-based training methods.
tags: [miles, post-training, rl]
---
...
<!-- Source: .faos/custom/skills/ai-research/miles/SKILL.md -->
