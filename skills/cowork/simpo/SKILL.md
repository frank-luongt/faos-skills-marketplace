...
---
name: simpo
description: SimPO simple preference optimization without reference models. Use when aligning models with a simpler alternative to DPO that doesn't require reference model.
tags: [simpo, post-training, rl]
---
...
<!-- Source: .faos/custom/skills/ai-research/simpo/SKILL.md -->
