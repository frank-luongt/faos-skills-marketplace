...
description: FlashAttention IO-aware exact attention algorithm. Use when optimizing transformer inference and training speed with memory-efficient attention.
tags: [flash-attention, optimization, quantization]
---
...
<!-- Source: .faos/custom/skills/ai-research/flash-attention/SKILL.md -->
