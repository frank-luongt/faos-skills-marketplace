...
---
name: axolotl
description: Axolotl streamlined fine-tuning framework. Use when fine-tuning LLMs with multiple dataset formats, LoRA, QLoRA, or full fine-tuning via YAML configs.
tags: [axolotl, fine-tuning, training]
---
...
<!-- Source: .faos/custom/skills/ai-research/axolotl/SKILL.md -->
