...
---
name: phoenix
description: Arize Phoenix open-source LLM observability and evaluation. Use when tracing LLM calls, analyzing embeddings, or running evals locally.
tags: [phoenix, observability, tracing]
---
...
<!-- Source: .faos/custom/skills/ai-research/phoenix/SKILL.md -->
