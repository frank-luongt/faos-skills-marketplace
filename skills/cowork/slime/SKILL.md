...
---
name: slime
description: SLIME self-improvement framework for language models. Use when implementing self-play or iterative improvement training loops.
tags: [slime, post-training, rl]
---
...
<!-- Source: .faos/custom/skills/ai-research/slime/SKILL.md -->
