...
description: Knowledge distillation techniques for model compression. Use when transferring knowledge from large teacher models to smaller student models.
tags: [knowledge-distillation, emerging, research, compression]
---
...
<!-- Source: .faos/custom/skills/ai-research/knowledge-distillation/SKILL.md -->
