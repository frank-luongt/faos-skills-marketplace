...
---
name: llamaindex
description: LlamaIndex data framework for LLM applications with 160+ data connectors. Use when building RAG systems, query engines, or knowledge-augmented AI.
tags: [llamaindex, agents, orchestration]
---
...
<!-- Source: .faos/custom/skills/ai-research/llamaindex/SKILL.md -->
