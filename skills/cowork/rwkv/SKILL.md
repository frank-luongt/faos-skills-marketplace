...
---
name: rwkv
description: RWKV linear-attention RNN-Transformer hybrid architecture. Use when needing efficient inference with linear time complexity for long sequences.
tags: [rwkv, model-architecture, training]
---
...
<!-- Source: .faos/custom/skills/ai-research/rwkv/SKILL.md -->
