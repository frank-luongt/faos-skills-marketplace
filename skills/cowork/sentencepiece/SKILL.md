...
---
name: sentencepiece
description: SentencePiece unsupervised text tokenizer. Use when training BPE or Unigram tokenizers from scratch on custom corpora.
tags: [sentencepiece, tokenization, nlp]
---
...
<!-- Source: .faos/custom/skills/ai-research/sentencepiece/SKILL.md -->
