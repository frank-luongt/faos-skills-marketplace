...
---
name: llama-cpp
description: llama.cpp efficient C/C++ LLM inference engine. Use when deploying quantized models on CPU or consumer GPU hardware with minimal dependencies.
tags: [llama-cpp, inference, serving]
---
...
<!-- Source: .faos/custom/skills/ai-research/llama-cpp/SKILL.md -->
