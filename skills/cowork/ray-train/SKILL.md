...
---
name: ray-train
description: Ray Train distributed training framework. Use when orchestrating distributed training across heterogeneous compute with fault tolerance.
tags: [ray-train, distributed-training, scaling]
---
...
<!-- Source: .faos/custom/skills/ai-research/ray-train/SKILL.md -->
