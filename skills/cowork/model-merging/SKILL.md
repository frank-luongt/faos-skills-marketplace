...
---
name: model-merging
description: Model merging techniques (TIES, DARE, SLERP, Task Arithmetic). Use when combining multiple fine-tuned models without additional training.
tags: [model-merging, emerging, research, model-composition]
---
...
<!-- Source: .faos/custom/skills/ai-research/model-merging/SKILL.md -->
