...
---
name: lambda-labs
description: Lambda Labs GPU cloud infrastructure. Use when provisioning on-demand GPU instances for ML training and inference workloads.
tags: [lambda-labs, infrastructure, gpu-cloud, gpu-cloud]
---
...
<!-- Source: .faos/custom/skills/ai-research/lambda-labs/SKILL.md -->
