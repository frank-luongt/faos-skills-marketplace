...
---
name: torchforge
description: TorchForge post-training toolkit for PyTorch models. Use when applying custom post-training optimizations or reward-based fine-tuning.
tags: [torchforge, post-training, rl]
---
...
<!-- Source: .faos/custom/skills/ai-research/torchforge/SKILL.md -->
