...
---
name: megatron-core
description: NVIDIA Megatron-Core for large-scale model training. Use when training 10B+ parameter models with tensor, pipeline, and expert parallelism.
tags: [megatron-core, distributed-training, scaling]
---
...
<!-- Source: .faos/custom/skills/ai-research/megatron-core/SKILL.md -->
