...
description: Sentence Transformers library for text embeddings. Use when generating dense vector embeddings for semantic search, clustering, or RAG.
tags: [sentence-transformers, rag, vector-db]
---
...
<!-- Source: .faos/custom/skills/ai-research/sentence-transformers/SKILL.md -->
