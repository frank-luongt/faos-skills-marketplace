...
---
name: skypilot
description: SkyPilot multi-cloud GPU orchestration framework. Use when finding cheapest GPU availability across AWS, GCP, Azure, and Lambda.
tags: [skypilot, infrastructure, gpu-cloud, multi-cloud]
---
...
<!-- Source: .faos/custom/skills/ai-research/skypilot/SKILL.md -->
