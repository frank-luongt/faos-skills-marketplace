...
---
name: verl
description: vERL efficient reinforcement learning for LLMs. Use when training models with RL methods optimized for large-scale GPU clusters.
tags: [verl, post-training, rl]
---
...
<!-- Source: .faos/custom/skills/ai-research/verl/SKILL.md -->
