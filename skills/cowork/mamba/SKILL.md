...
---
name: mamba
description: Mamba selective state-space model architecture. Use when exploring alternatives to Transformer attention for efficient sequence modeling.
tags: [mamba, model-architecture, training]
---
...
<!-- Source: .faos/custom/skills/ai-research/mamba/SKILL.md -->
