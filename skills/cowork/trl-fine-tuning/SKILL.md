...
description: TRL (Transformer Reinforcement Learning) library for SFT, DPO, PPO, and reward modeling. Use when applying RLHF or preference-based training methods.
tags: [trl-fine-tuning, post-training, rl]
---
...
<!-- Source: .faos/custom/skills/ai-research/trl-fine-tuning/SKILL.md -->
