...
---
name: autogpt
description: AutoGPT autonomous agent framework. Use when building self-directed AI agents that can decompose and execute complex multi-step tasks.
tags: [autogpt, agents, orchestration]
---
...
<!-- Source: .faos/custom/skills/ai-research/autogpt/SKILL.md -->
