...
---
name: nemo-curator
description: NVIDIA NeMo Curator for large-scale data curation. Use when filtering, deduplicating, or cleaning training datasets at scale.
tags: [nemo-curator, data-processing, training-data]
---
...
<!-- Source: .faos/custom/skills/ai-research/nemo-curator/SKILL.md -->
