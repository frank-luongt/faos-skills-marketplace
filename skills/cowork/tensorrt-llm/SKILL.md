...
---
name: tensorrt-llm
description: NVIDIA TensorRT-LLM optimized inference for production deployments. Use when maximizing LLM inference throughput on NVIDIA GPUs.
tags: [tensorrt-llm, inference, serving]
---
...
<!-- Source: .faos/custom/skills/ai-research/tensorrt-llm/SKILL.md -->
