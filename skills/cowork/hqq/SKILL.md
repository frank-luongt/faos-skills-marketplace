...
---
name: hqq
description: HQQ half-quadratic quantization for efficient LLM inference. Use when applying fast zero-shot quantization without calibration data.
tags: [hqq, optimization, quantization]
---
...
<!-- Source: .faos/custom/skills/ai-research/hqq/SKILL.md -->
