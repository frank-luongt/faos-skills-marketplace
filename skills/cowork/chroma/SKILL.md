...
---
name: chroma
description: Chroma open-source embedding database for RAG applications. Use when implementing lightweight vector storage and retrieval for development or production.
tags: [chroma, rag, vector-db]
---
...
<!-- Source: .faos/custom/skills/ai-research/chroma/SKILL.md -->
