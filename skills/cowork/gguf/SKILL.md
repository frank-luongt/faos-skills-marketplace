...
---
name: gguf
description: GGUF model format for efficient CPU and GPU inference. Use when converting and deploying quantized models with llama.cpp ecosystem.
tags: [gguf, optimization, quantization, model-format]
---
...
<!-- Source: .faos/custom/skills/ai-research/gguf/SKILL.md -->
