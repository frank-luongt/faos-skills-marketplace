...
**Support for dataset_catalog and dataset_schema parameters added in Databricks CLI 0.281.0
(January 2026)**
...
**See [alerts_guidance.md](alerts_guidance.md)** - Alert schema differs significantly from other
resources
...
<!-- Source: .faos/custom/skills/cloud/databricks/databricks-asset-bundles/SKILL.md -->
