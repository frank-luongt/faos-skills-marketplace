...
---
name: moe-training
description: Mixture-of-Experts (MoE) training and architecture patterns. Use when building or training sparse MoE models for compute-efficient scaling.
tags: [moe-training, emerging, research, sparse-models]
---
...
<!-- Source: .faos/custom/skills/ai-research/moe-training/SKILL.md -->
