...
---
name: pinecone
description: Pinecone managed vector database for production RAG. Use when deploying scalable vector search with managed infrastructure and hybrid search.
tags: [pinecone, rag, vector-db]
---
...
<!-- Source: .faos/custom/skills/ai-research/pinecone/SKILL.md -->
