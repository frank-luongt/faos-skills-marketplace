...
---
name: torchtitan
description: PyTorch TorchTitan large-scale training framework. Use when training large models with FSDP2, tensor parallelism, or float8 optimization.
tags: [torchtitan, model-architecture, training]
---
...
<!-- Source: .faos/custom/skills/ai-research/torchtitan/SKILL.md -->
