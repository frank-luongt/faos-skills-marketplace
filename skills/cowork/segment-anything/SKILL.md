...
description: Meta SAM (Segment Anything Model) for image segmentation. Use when implementing universal image segmentation or object detection tasks.
tags: [segment-anything, multimodal, vision-language]
---
...
<!-- Source: .faos/custom/skills/ai-research/segment-anything/SKILL.md -->
