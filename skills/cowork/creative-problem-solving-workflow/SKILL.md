---
name: creative-problem-solving-workflow
description: "Apply systematic problem-solving methodologies including TRIZ, Theory of Constraints, root cause analysis, and creative solution generation."
tags: [creative, problem-solving, workflow, facilitation]
---
...
processed: {project_root}/.faos/cis/workflows/problem-solving/workflow.yaml</critical>
<critical>Load and understand solving methods from: {solving_methods}</critical> <critical>⚠️
...
<template-output>problem_title</template-output> <template-output>problem_category</template-output>
...
<template-output>restraining_forces</template-output> <template-output>constraints</template-output>
...
<template-output>action_steps</template-output> <template-output>timeline</template-output>
...
<template-output>key_learnings</template-output> <template-output>what_worked</template-output>
