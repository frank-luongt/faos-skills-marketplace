...
description: BigCode evaluation harness for code generation models. Use when benchmarking code LLMs on HumanEval, MBPP, and other coding tasks.
tags: [bigcode-evaluation-harness, evaluation, benchmarking]
---
...
<!-- Source: .faos/custom/skills/ai-research/bigcode-evaluation-harness/SKILL.md -->
