...
---
name: pytorch-fsdp2
description: PyTorch FSDP2 fully sharded data parallelism. Use when training large models with per-parameter sharding and composable parallelism.
tags: [pytorch-fsdp2, distributed-training, scaling]
---
...
<!-- Source: .faos/custom/skills/ai-research/pytorch-fsdp2/SKILL.md -->
