...
> Chroma open-source embedding database for RAG applications. Use when implementing lightweight vector storage and retrieval for development or production.
