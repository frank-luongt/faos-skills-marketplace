...
> Conversion-focused marketing copy for landing pages and emails with brief confirmation and no-fabrication rules. Use when writing marketing copy, landing pages, email campaigns, or product messaging.
...
- [Julian Shapiro - Writing Well](https://www.julian.com/guide/write/intro)
