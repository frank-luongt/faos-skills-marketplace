...
> ServiceNow Now Assist and AI Agent integration patterns. Use when building AI agents for ITSM (incidents, changes, CMDB), CSM, HR service delivery, or integrating with ServiceNow's Flow Designer and Table API.
