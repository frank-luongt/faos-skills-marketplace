...
> Comprehensive Terraform and OpenTofu guidance covering testing, modules, CI/CD, and production patterns. Use when creating Terraform configurations, structuring modules, setting up IaC testing, or implementing CI/CD for infrastructure.
