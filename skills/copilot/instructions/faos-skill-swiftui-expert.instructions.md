...
> Write, review, or improve SwiftUI code following best practices for state management, view composition, performance, modern APIs, and Swift concurrency. Use when building new SwiftUI features, refactoring views, or adopting iOS 26+ Liquid Glass styling.
