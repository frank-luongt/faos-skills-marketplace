...
> Google Agentspace patterns for enterprise AI search and agents. Use when building unified search across 100+ enterprise connectors (SharePoint, Confluence, Jira, Salesforce, ServiceNow), identity-aware access, or custom Agentspace agents.
