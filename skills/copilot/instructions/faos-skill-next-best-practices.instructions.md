...
> Vercel's authoritative Next.js 15+ patterns covering RSC boundaries, streaming, async patterns, route handlers, metadata, image/font optimization, bundling, hydration errors, parallel routes, and self-hosting. Use when: nextjs, next.js, app router, server components, RSC, next best practices.
