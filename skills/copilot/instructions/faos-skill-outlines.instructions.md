...
> Outlines structured text generation with guaranteed JSON/regex output. Use when enforcing structured outputs from local LLMs with grammar-based decoding.
