...
> Manage hiring pipelines, analyze compensation data, create performance review templates, and design onboarding checklists. Use when building HR processes, conducting comp analysis, designing review cycles, or structuring employee onboarding.
