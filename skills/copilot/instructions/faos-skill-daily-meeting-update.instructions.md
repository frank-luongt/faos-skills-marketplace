...
> Interactive daily standup/meeting update generator. Use when preparing for daily standup, scrum meetings, or team syncs. Pulls activity from GitHub, Jira, and session history, conducts a 4-question interview (yesterday, today, blockers, discussion topics), and generates formatted Markdown update.
