...
> Strict TDD enforcement with Red-Green-Refactor cycle, rationalization rebuttals, and verification checklists. Use when implementing any feature or bugfix to ensure test-first discipline.
