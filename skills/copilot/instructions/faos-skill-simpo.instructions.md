...
> SimPO simple preference optimization without reference models. Use when aligning models with a simpler alternative to DPO that doesn't require reference model.
