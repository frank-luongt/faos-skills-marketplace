...
> LitGPT framework for training, fine-tuning, and deploying LLMs with Lightning. Use when building or customizing LLM architectures with PyTorch Lightning integration.
