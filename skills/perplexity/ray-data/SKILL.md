...
---
name: ray-data
description: Ray Data scalable data processing for ML pipelines. Use when building distributed data loading and transformation pipelines for training.
tags: [ray-data, data-processing, training-data]
---
...
<!-- Source: .faos/custom/skills/ai-research/ray-data/SKILL.md -->
