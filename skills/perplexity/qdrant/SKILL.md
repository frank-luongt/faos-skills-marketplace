...
---
name: qdrant
description: Qdrant vector database with advanced filtering and payload indexing. Use when building production RAG systems needing rich metadata filtering.
...
<!-- Source: .faos/custom/skills/ai-research/qdrant/SKILL.md -->
