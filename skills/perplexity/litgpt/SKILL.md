...
---
name: litgpt
description: LitGPT framework for training, fine-tuning, and deploying LLMs with Lightning. Use when building or customizing LLM architectures with PyTorch Lightning integration.
tags: [litgpt, model-architecture, training]
---
...
<!-- Source: .faos/custom/skills/ai-research/litgpt/SKILL.md -->
