...
---
name: memory-systems
description: "Production AI memory framework comparison and implementation guide. Covers Mem0, Zep/Graphiti, Letta, LangMem, Cognee with benchmark data (DMR accuracy, LoCoMo scores). Includes memory layer design (working, short-term, long-term, entity, temporal KG) and retrieval strategies. Use when: agent memory, memory systems, persistent memory, knowledge graphs, memory framework selection."
tags: [memory, agents, knowledge-graph, retrieval]
---
...
- `context-compression` - Compression relates to scratchpad and summary memory patterns
...
<!-- Source: .faos/custom/skills/ai-ml/memory-systems/SKILL.md -->
