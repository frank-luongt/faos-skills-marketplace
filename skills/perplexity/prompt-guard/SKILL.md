...
---
name: prompt-guard
description: Prompt Guard detection model for prompt injection attacks. Use when implementing input validation and prompt injection defense in LLM applications.
tags: [prompt-guard, safety, alignment, prompt-injection]
---
...
<!-- Source: .faos/custom/skills/ai-research/prompt-guard/SKILL.md -->
