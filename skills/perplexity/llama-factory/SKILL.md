...
---
name: llama-factory
description: LLaMA Factory unified fine-tuning framework for 100+ LLMs. Use when fine-tuning models with a web UI, CLI, or advanced training methods.
tags: [llama-factory, fine-tuning, training]
---
...
<!-- Source: .faos/custom/skills/ai-research/llama-factory/SKILL.md -->
