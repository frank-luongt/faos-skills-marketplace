...
---
name: openrlhf
description: OpenRLHF scalable RLHF training framework. Use when training models with PPO, DPO, or reward modeling at scale across multiple nodes.
tags: [openrlhf, post-training, rl]
---
...
<!-- Source: .faos/custom/skills/ai-research/openrlhf/SKILL.md -->
