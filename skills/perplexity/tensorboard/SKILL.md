...
---
name: tensorboard
description: TensorBoard visualization toolkit for ML training monitoring. Use when visualizing training metrics, model graphs, or profiling GPU performance.
tags: [tensorboard, mlops, experiment-tracking]
---
...
<!-- Source: .faos/custom/skills/ai-research/tensorboard/SKILL.md -->
