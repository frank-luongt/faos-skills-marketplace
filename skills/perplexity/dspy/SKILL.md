...
---
name: dspy
description: DSPy programmatic prompt optimization framework. Use when building self-improving prompt pipelines with automated prompt tuning and evaluation.
tags: [dspy, prompt-engineering, structured-output]
---
...
<!-- Source: .faos/custom/skills/ai-research/dspy/SKILL.md -->
