...
---
name: langsmith
description: LangSmith LLM observability and evaluation platform. Use when tracing, debugging, and evaluating LLM application performance in production.
...
<!-- Source: .faos/custom/skills/ai-research/langsmith/SKILL.md -->
