...
Databricks Jobs orchestrate data workflows with multi-task DAGs, flexible triggers, and
comprehensive monitoring. Jobs support diverse task types and can be managed via Python SDK, CLI, or
Asset Bundles.
...
- **[spark-declarative-pipelines](../spark-declarative-pipelines/SKILL.md)** - Configure pipelines
  triggered by jobs
...
<!-- Source: .faos/custom/skills/cloud/databricks/databricks-jobs/SKILL.md -->
