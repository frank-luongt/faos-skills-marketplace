...
description: Speculative decoding acceleration for LLM inference. Use when speeding up autoregressive generation with draft models (Medusa, Lookahead).
tags: [speculative-decoding, emerging, research, inference-speed]
---
...
<!-- Source: .faos/custom/skills/ai-research/speculative-decoding/SKILL.md -->
