...
description: GRPO reinforcement learning training with TRL. Use when applying Group Relative Policy Optimization for reasoning and task-specific model training.
tags: [grpo-rl-training, post-training, rl, grpo, reasoning]
---
...
<!-- Source: .faos/custom/skills/ai-research/grpo-rl-training/SKILL.md -->
