...
description: Expert guidance for building modern Android UIs with Jetpack Compose. Use when starting a new Android project, migrating XML layouts to Compose, implementing state management, or optimizing recomposition performance.
...
<!-- Source: .faos/custom/skills/frontend/android-jetpack-compose/SKILL.md -->
