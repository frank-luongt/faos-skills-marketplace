...
---
name: model-pruning
description: Model pruning and sparsification techniques. Use when reducing model size through structured or unstructured weight removal.
tags: [model-pruning, emerging, research, compression]
---
...
<!-- Source: .faos/custom/skills/ai-research/model-pruning/SKILL.md -->
