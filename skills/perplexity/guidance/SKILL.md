...
---
name: guidance
description: Guidance constrained generation library for LLMs. Use when enforcing structured outputs with templates, grammars, or token-level constraints.
tags: [guidance, prompt-engineering, structured-output]
---
...
<!-- Source: .faos/custom/skills/ai-research/guidance/SKILL.md -->
