...
---
name: modal
description: Modal serverless GPU compute platform. Use when running ML workloads on serverless GPUs with container-based deployments.
tags: [modal, infrastructure, gpu-cloud, serverless]
---
...
<!-- Source: .faos/custom/skills/ai-research/modal/SKILL.md -->
