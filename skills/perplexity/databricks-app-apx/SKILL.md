...
**Do NOT invoke if user specifies**: Streamlit, Dash, Node.js, Shiny, Gradio, Flask, or other
frameworks.
...
The APX MCP server can automatically check deployed application logs. Simply ask: "Please check the
deployed app logs for <app-name>"
...
**Deployed app not working**: Ask to check deployed app logs (APX MCP will automatically retrieve
