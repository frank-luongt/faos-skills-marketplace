...
---
name: awq
description: AWQ activation-aware weight quantization for LLMs. Use when quantizing models to 4-bit with minimal accuracy loss for efficient inference.
tags: [awq, optimization, quantization]
---
...
<!-- Source: .faos/custom/skills/ai-research/awq/SKILL.md -->
