...
---
name: accelerate
description: Hugging Face Accelerate for distributed training across GPUs/TPUs. Use when scaling training to multi-GPU or multi-node setups with minimal code changes.
tags: [accelerate, distributed-training, scaling]
---
...
<!-- Source: .faos/custom/skills/ai-research/accelerate/SKILL.md -->
