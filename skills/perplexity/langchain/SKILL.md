...
---
name: langchain
description: LangChain LLM application framework for chains, agents, and RAG. Use when building complex LLM pipelines with tool use, memory, and retrieval.
tags: [langchain, agents, orchestration]
---
...
<!-- Source: .faos/custom/skills/ai-research/langchain/SKILL.md -->
