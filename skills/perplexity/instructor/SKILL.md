...
---
name: instructor
description: Instructor structured output extraction from LLMs. Use when extracting typed, validated data from LLM responses using Pydantic models.
tags: [instructor, prompt-engineering, structured-output]
---
...
<!-- Source: .faos/custom/skills/ai-research/instructor/SKILL.md -->
