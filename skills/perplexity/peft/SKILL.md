...
---
name: peft
description: Hugging Face PEFT parameter-efficient fine-tuning library. Use when applying LoRA, QLoRA, IA3, or other adapter methods to reduce training cost.
tags: [peft, fine-tuning, training]
---
...
<!-- Source: .faos/custom/skills/ai-research/peft/SKILL.md -->
