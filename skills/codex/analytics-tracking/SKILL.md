...
description: Analytics implementation and measurement design for trustworthy decision-grade data. Use when designing tracking plans, implementing event models, auditing analytics accuracy, or setting up conversion measurement.
---
...
<!-- Source: .faos/custom/skills/business/analytics-tracking/SKILL.md -->
