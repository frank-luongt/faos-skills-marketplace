...
---
name: crewai
description: CrewAI multi-agent orchestration framework. Use when building teams of AI agents with role-based task delegation and sequential/hierarchical execution.
---
...
<!-- Source: .faos/custom/skills/ai-research/crewai/SKILL.md -->
