...
---
name: vllm
description: vLLM high-throughput LLM serving engine with PagedAttention. Use when deploying models in production with optimal GPU memory utilization and batching.
---
...
<!-- Source: .faos/custom/skills/ai-research/vllm/SKILL.md -->
